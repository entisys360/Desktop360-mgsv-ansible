...
AZURE_CREDENTIAL_ENV_MAPPING = dict(
    ...
    subscription_id='3e974a5c-42e9-4191-ad4a-00eb47e1d717', #'AZURE_SUBSCRIPTION_ID',
    client_id='e55a6c20-cc32-40f9-b41c-a527aef645d3', #'AZURE_CLIENT_ID',
    secret='u5ouCa~h_LPOc72C_DFCb.35S9J-cIkO-~', #'AZURE_SECRET',
    tenant='AZURE_TENANT',
